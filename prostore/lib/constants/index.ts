export const APP_NAME = process.env.NEXT_PUBLIC_APP_NAME || "South Shore 3D Printing";
export const APP_DESCRIPTION = process.env.NEXT_PUBLIC_APP_DESCRIPTION || "South Shore 3D Printing";
export const SERVER_URL = process.env.SERVER_URL || "http://localhost:3000";
export const APP_URL = process.env.NEXT_PUBLIC_APP_URL || "https://southshore3dprinting.com";
